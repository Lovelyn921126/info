	...
	@GetMapping("/ad/{id}")
	 protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {  
	    ...
	    {  
	        ...
	        datasource.setUrl("jdbc:mysql://39.106.59.144:8066/TESTDB?useUnicode=true&characterEncoding=utf-8&autoReconnect=true");  
	        ...
	        jedisPool = new JedisPool(poolConfig, "39.106.59.144", 1111);  
	    }  
	    ...
	    private String queryDB(Long id) throws Exception {  
	        ...
	        try {  
	            ...
	            String sql = "select content from ad where id_ = ?";  
